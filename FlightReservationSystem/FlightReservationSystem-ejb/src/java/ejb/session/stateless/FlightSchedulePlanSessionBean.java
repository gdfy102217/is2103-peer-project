...
public class FlightSchedulePlanSessionBean implements FlightSchedulePlanSessionBeanRemote, FlightSchedulePlanSessionBeanLocal {
    ...
    public void updateSingleFlightSchedulePlan (FlightSchedulePlan flightSchedulePlan, FlightSchedule flightSchedule, Date departureDateTime, Date durationTime) throws UpdateFlightSchedulePlanException{
        em.merge(flightSchedulePlan);
